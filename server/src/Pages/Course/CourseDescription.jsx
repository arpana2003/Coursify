...
function CourseDescription() {
  ...
  //useSelector hook from React Redux allows you to extract data from the Redux store state
  ...
  return (
    <HomeLayout>
      <div className="pt-12 px-20 flex flex-col items-center justify-center text-white min-h-[90vh]">
