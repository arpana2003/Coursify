    ...
    <HomeLayout>
      ...
      >
        <div className="w-80 h-[26rem] flex flex-col justify-center shadow-[0_0_10px_black] rounded-lg relative">
          <h1 className="bg-yellow-500 absolute top-0 w-full text-center py-2 text-2xl font-bold rounded-tl-lg rounded-tr-lg">
            Subscription Bundle
          </h1>
          <div className="px-4 space-y-5 text-center">
            <p className="text-[17px]">
              This purchase will let access all available courses of our
              platform for{" "}
            ...
            <div className="text-gray-200">
              ...
              <p>* Terms and conditions included</p>
            </div>
            <button
              type="submit"
